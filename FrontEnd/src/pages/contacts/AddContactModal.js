        ...
        <Box sx={style}>
          ...
          <form className="flex flex-col space-y-3" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-row justify-around !mt-5">
              <button
                className="px-6 py-1 rounded-xl text-sm border border-2 border-cyan-950 hover:bg-cyan-950 hover:text-white"
                onClick={close}
              >
                Cancel
              </button>
              <button
                type="submit"
                className="px-7 py-1 rounded-xl text-sm border border-2 border-cyan-950 hover:bg-cyan-950 hover:text-white"
              >
                Save
              </button>
            </div>
