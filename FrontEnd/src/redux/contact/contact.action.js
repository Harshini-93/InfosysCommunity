  ...
  return async function (dispatch) {
    ...
    try {
      ...
      const response = await axios.post(
        "http://localhost:8084/api/addContact",
        formData,
        {
          headers: {
  ...
  return async function (dispatch) {
    ...
    try {
      ...
      const response = await axios.put(
        `http://localhost:8084/api/updateContact/${emergencyId}`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${jwtToken}`,
  ...
  return async function (dispatch) {
    ...
    try {
      ...
      const response = await axios.delete(
        `http://localhost:8084/api/deleteContact/${emergencyId}`,
        {
          headers: {
            Authorization: `Bearer ${jwtToken}`,
            "Content-Type": "application/json",
  ...
  return async function (dispatch) {
    ...
    try {
      ...
      const response = await axios.get(
        `http://localhost:8084/api/getAllContacts`,
        {
          headers: {
            Authorization: `Bearer ${jwtToken}`,
            "Content-Type": "application/json",
      ...
      dispatch({
        ...
        payload: "Failed To Get Contacts",
      });
    }
  };
}
