  ...
  return async function (dispatch) {
    ...
    try {
      ...
      const response = await axios.post(
        `http://localhost:8083/api/addVendor`,
        vendorData.data,
        {
          headers: {
      ...
      dispatch({
        ...
        payload: "Added Vendor Successfully",
      });
    } catch (error) {
...
function requestService(requestData) {
  return async function (dispatch) {
    ...
    try {
      const jwtToken = localStorage.getItem("jwt");
      const response = await axios.post(
        `http://localhost:8083/api/sendRequest`,
        requestData.data,
        {
          headers: {
            Authorization: `Bearer ${jwtToken}`,
      ...
      dispatch({
        ...
        payload: "Unable To Send Request",
      });
    }
  };
}
  ...
  return async function (dispatch) {
    ...
    try {
      ...
      const response = await axios.put(
        `http://localhost:8083/api/updateVendor/${vendorId}`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${jwtToken}`,
  ...
  return async function (dispatch) {
    ...
    try {
      ...
      const response = await axios.delete(
        `http://localhost:8083/api/deleteVendor/${vendorId}`,
        {
          headers: {
            Authorization: `Bearer ${jwtToken}`,
            "Content-Type": "application/json",
  ...
  return async function (dispatch) {
    ...
    try {
      ...
      const response = await axios.get(
        `http://localhost:8083/api/getAllVendors`,
        {
          headers: {
            Authorization: `Bearer ${jwtToken}`,
            "Content-Type": "application/json",
...
export { addVendor, requestService, deleteVendor, getAllVendors };
